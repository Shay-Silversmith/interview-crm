      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative flex items-center">
          ...
          <input
            ...
            className={cn(
              'w-full h-9 rounded-lg border border-slate-200 bg-surface px-3 text-sm text-slate-800',
    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <textarea
          ...
          id={inputId}
          className={cn(
            'w-full rounded-lg border border-slate-200 bg-surface px-3 py-2 text-sm text-slate-800',
